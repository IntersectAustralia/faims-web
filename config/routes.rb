FaimsWeb::Application.routes.draw do
  ...
  get "android/project/:key/server_file_upload", :to => "android#server_file_upload", :as => "server_file_upload"
  get "android/project/:key/app_file_upload", :to => "android#app_file_upload", :as => "app_file_upload"
